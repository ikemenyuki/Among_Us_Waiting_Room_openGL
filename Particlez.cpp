...
void Particlez::draw(const glm::mat4& view, const glm::mat4& projection, GLuint shader)
{
...
void Particlez::update()
{
    // Spin the cube by 1 degree
    spin(0.1f);
}

void Particlez::updatePointSize(GLfloat size)
{
    /*
